          ...
          <table className='table caption-top table-dark table-hover rounded mt-2'>
            ...
            <thead>
              <tr>
                ...
                <th scope='col'>Department</th> <th scope='col'>Payment</th>
            ...
            <tbody>
              ...
              <tr>
                <th scope='row'>2</th> <td>Mark</td> <td>Otto</td>
                <td>@mdo</td>
                <td>
                  <i className='bi bi-check-lg'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                  <i className='bi bi-x-lg'></i>
              ...
              <tr>
                <th scope='row'>3</th> <td>Mark</td> <td>Otto</td>
                <td>@mdo</td>
                <td>
                  <i className='bi bi-check-lg'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                  <i className='bi bi-x-lg'></i>
              ...
              <tr>
                <th scope='row'>4</th> <td>Mark</td> <td>Otto</td>
                <td>@mdo</td>
                <td>
                  <i className='bi bi-check-lg'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                  <i className='bi bi-x-lg'></i>
              ...
              <tr>
                <th scope='row'>5</th> <td>Mark</td> <td>Otto</td>
                <td>@mdo</td>
                <td>
                  <i className='bi bi-check-lg'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                  <i className='bi bi-x-lg'></i>
              ...
              <tr>
                <th scope='row'>6</th> <td>Mark</td> <td>Otto</td>
                <td>@mdo</td>
                <td>
                  <i className='bi bi-check-lg'></i>&nbsp;&nbsp;&nbsp;&nbsp;
                  <i className='bi bi-x-lg'></i>
